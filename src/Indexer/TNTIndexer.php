...
class TNTIndexer
{
    ...
    protected mixed $selectWordlistStmt = null;
    protected mixed $updateWordlistStmt = null;
    ...
    public function createIndex($indexName)
    {
        ...
        // Beware as $this->config['storage'] MUST be local for this to work.
        // Otherwise you might get "General error: 5 database is locked" all the time.
        // Switching $this->config['storage'] from a mounted drive (with proper permissions) to /tmp fixed it.
        if ($this->config['wal']) {
